...
export const metadata: Metadata = {
  title: "Privacy Policy | Next Key Global Solutions LLC",
  description: "Privacy policy for Next Key Global Solutions LLC - NYC tenant placement and housing access services.",
}
            ...
            <CardContent className="p-8 space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Next Key Global Solutions LLC collects information you provide directly to us, such as when you create an account, 
                  submit a unit listing, apply for housing support, or contact us for assistance.
                </p>
                <p className="text-gray-600">
                  This may include your name, email address, phone number, property information, and other details necessary 
                  to provide our tenant placement and housing access services.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-2">
                  <li>Provide tenant placement services and housing access support</li>
                  <li>Match landlords with qualified tenants</li>
                  <li>Coordinate voucher programs and compliance requirements</li>
                  <li>Communicate with you about our services</li>
                  <li>Improve our services and user experience</li>
                  <li>Comply with legal obligations and housing regulations</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-2">
                  <li>With housing authorities and voucher programs as required for compliance</li>
                  <li>With landlords and tenants as necessary for placement services</li>
